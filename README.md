...
hyprland kitty dunst waybar                    
fzf jq inotify-tools imagemagick swww         
...
mkdir -p ~/.config/themes/tools ~/.config/dash ~/.config/hypr ~/.config/dunst && cp color.sh ~/.config/themes/tools/ && cp colors.conf ~/.config/themes/ && cp dashboard.sh ~/.config/dash/ && cp dunstrc ~/.config/dunst/ && cp hypridle.conf ~/.config/hypr/ && cp hyprland.conf ~/.config/hypr/ && cp hyprock-colors.conf ~/.config/hypr/hyprlock-colors.conf && cp hyprock.conf ~/.config/hypr/hyprlock.conf && cp launcher.sh ~/.config/dash/ && cp picker.sh ~/.config/themes/tools/ && cp preview.sh ~/.config/themes/tools/ && cp screenshot.sh ~/.config/dash/ && cp sync.sh ~/.config/themes/tools/ && chmod +x ~/.config/themes/tools/*.sh ~/.config/dash/*.sh
