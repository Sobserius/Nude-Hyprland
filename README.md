...
To install the rice, run inside the folder command and then reboot <span style="color: red;">(Install with caution, the script below replaces hyprland.conf) <span>:
```console
...
Themes are saved at ~/.config/themes/palettes. I recommend you to use <span style="color: blue;">https://github.com/dexpota/kitty-themes </span>
